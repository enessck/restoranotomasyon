...
namespace RestaurantOtomasyon
{
    public partial class frmLock : Form
    {
        ...
        private const decimal KDV_ORANI = 0.08m;
        private const decimal INDIRIM_ORANI = 0.10m;
        ...
        private void PaymentForm_Load(object sender, EventArgs e)
        {
            ...
            {
                var currentOrder = context.Orders.FirstOrDefault(o => o.RestaurantTableId == _tableId && !o.IsCompleted);
        ...
        private void lblIndirimTutari_Click(object sender, EventArgs e)
        {
